...
ready_data_saving_dir = "data/ready_for_neo4j"
...
#this runs NER, RE, and Linking (normalization) 
#and saves extracted entities and relations to two separate csv files.
annotate_mongo_articles(ents_path=extracted_entities, rels_path=extracted_relations)
...
clean_paths = prepare_data_for_neo4j(raw_ents_path=extracted_entities,
                       ...
                       saving_dir=ready_data_saving_dir)
